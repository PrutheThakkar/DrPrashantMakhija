        ...
        <div className="footer-col footer-brand">
          <div className="brand-logo">
            <div className="wrapper">
              <img src="https://app.drprashantmakhija.com/wp-content/uploads/2026/06/DPM-Footer-Logo.webp" alt="Logo" />
            </div>
          </div>
          ...
          <div className="social-row">
            <div className="social-icons">
              <a href="#" title="X / Twitter"></a>
               ...
               <a href="https://www.instagram.com/dr.prashantmakhija?igsh=ZGN6aHV4bHo0NmFr" title="insta">
